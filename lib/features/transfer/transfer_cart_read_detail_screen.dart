...
class TransferCartReadDetailScreen extends StatefulWidget {
  final CartModel cart;
  final int ismerge;
  const TransferCartReadDetailScreen({super.key, required this.cart, required this.ismerge});

  @override
  State<TransferCartReadDetailScreen> createState() => _TransferCartReadDetailScreenState();
}

class _TransferCartReadDetailScreenState extends State<TransferCartReadDetailScreen> {
