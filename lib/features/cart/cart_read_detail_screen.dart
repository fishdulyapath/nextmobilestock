...
class CartReadDetailScreen extends StatefulWidget {
  final CartModel cart;
  final int ismerge;
  const CartReadDetailScreen({super.key, required this.cart, required this.ismerge});

  @override
  State<CartReadDetailScreen> createState() => _CartReadDetailScreenState();
}

class _CartReadDetailScreenState extends State<CartReadDetailScreen> {
