...
class RequestCartMergeScreen extends StatefulWidget {
  final List<CartModel> cart;
  const RequestCartMergeScreen({super.key, required this.cart});

  @override
  State<RequestCartMergeScreen> createState() => _RequestCartMergeScreenState();
}

class _RequestCartMergeScreenState extends State<RequestCartMergeScreen> {
  // Theme Colors
