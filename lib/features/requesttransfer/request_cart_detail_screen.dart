...
import 'package:mobilestock/features/requesttransfer/request_cart_item_search.dart';
...
class RequestCartDetailScreen extends StatefulWidget {
  final CartModel cart;
  final int ismerge;
  const RequestCartDetailScreen({super.key, required this.cart, required this.ismerge});

  @override
  State<RequestCartDetailScreen> createState() => _RequestCartDetailScreenState();
}

class _RequestCartDetailScreenState extends State<RequestCartDetailScreen> {
                    ...
                    _buildActionButton(
                      ...
                      onTap: () async {
                        final res = await Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const RequestCartItemSearch()),
                        );
                        if (res != null) {
