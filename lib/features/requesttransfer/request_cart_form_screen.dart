...
class RequestCartFormScreen extends StatefulWidget {
  final CartModel cart;
  const RequestCartFormScreen({super.key, required this.cart});

  @override
  State<RequestCartFormScreen> createState() => _RequestCartFormScreenState();
}

class _RequestCartFormScreenState extends State<RequestCartFormScreen> {
  ...
  String generateBasketNumber() {
    ...
    return 'RT$year$month$day$hour$minute$randomDigits';
  }
}
