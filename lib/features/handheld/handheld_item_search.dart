...
class HandheldItemSearch extends StatefulWidget {
  const HandheldItemSearch({super.key});

  @override
  State<HandheldItemSearch> createState() => _HandheldItemSearchState();
}

class _HandheldItemSearchState extends State<HandheldItemSearch> {
