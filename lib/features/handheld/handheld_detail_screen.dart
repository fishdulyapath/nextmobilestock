...
import 'package:mobilestock/features/handheld/handheld_item_search.dart';
...
class HandheldDetailScreen extends StatefulWidget {
  final CartModel cart;
  final int ismerge;
  const HandheldDetailScreen({super.key, required this.cart, required this.ismerge});

  @override
  State<HandheldDetailScreen> createState() => _HandheldDetailScreenState();
}

class _HandheldDetailScreenState extends State<HandheldDetailScreen> {
                      ...
                      _buildActionButton(
                        ...
                        onTap: () async {
                          final res = await Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const HandheldItemSearch()),
                          );
                          if (res != null) {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (widget.cart.status != 5) const SizedBox(width: 4),
                      if (widget.cart.status != 5)
                        const Icon(
                          Icons.edit_outlined,
                          size: 14,
