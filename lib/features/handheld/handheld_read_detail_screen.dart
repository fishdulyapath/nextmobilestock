...
class HandheldReadDetailScreen extends StatefulWidget {
  final CartModel cart;
  final int ismerge;
  const HandheldReadDetailScreen({super.key, required this.cart, required this.ismerge});

  @override
  State<HandheldReadDetailScreen> createState() => _HandheldReadDetailScreenState();
}

class _HandheldReadDetailScreenState extends State<HandheldReadDetailScreen> {
